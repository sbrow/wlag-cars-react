              ...
              <JarvisWidget id="wid-id-2" editbutton={false} color="greenDark">
                ...
                <div>
                  <div className="widget-body no-padding">
                    ...
                    >
                      <i className="fa-fw fa fa-info" />
                      Enables hover effect <code>&lt;table&gt;</code> by adding
                      the <code>.table-hover</code> with the base class
                    </Alert>
                    <div className="table-responsive">
                ...
                <div>
                  <div className="widget-body no-padding">
                    ...
                    >
                      ...
                      <code>&lt;tr&gt;</code> by adding <code>.success</code>,
                      <code>.danger</code>,<code>.warning</code> and
                      <code>.info</code> respectively
                    </Alert>
                    <div className="table-responsive">
                      <table className="table">
                        <thead>
                          <tr>
                            <th>#</th>
                            <th>
                              <i className="fa fa-building" /> Product
                            </th>
                            <th>
                              <i className="fa fa-calendar" /> Payment Taken
                            </th>
                            <th>
                              <i className="glyphicon glyphicon-send" /> Status
                            </th>
                          </tr>
                        </thead>
                        <tbody>
                ...
                <div>
                  <div className="widget-body no-padding">
                    <Alert
                      ...
                      data-dismiss="alert"
                    >
                      <i className="fa-fw fa fa-info" />A combined table effect
